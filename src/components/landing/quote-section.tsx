...
const QuoteSection = () => {
  return (
    <section className="flex items-start justify-between gap-8 py-20 pb-[200px]">
      <figure className="mx-auto max-w-screen-md space-y-[40px]">
        ...
        <blockquote>
          <p className="ml-[72px] w-full max-w-[535px] align-middle text-[64px] leading-[100%] font-black tracking-[0%]">
      ...
      <div className="relative w-full flex-1">
        ...
        <Image
          ...
          height={130}
        />
        <div className="text-primary absolute right-[-50px] bottom-[-180px] z-10 flex w-[852px] items-center justify-between bg-[#061665] px-12 py-16">
          <div className="max-w-[430px] align-middle text-[40px] leading-[100%] font-black tracking-[0%]">
