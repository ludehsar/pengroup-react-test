...
const QuoteSection = () => {
  return (
    <section className="flex flex-col items-start justify-between gap-6 py-10 pb-20 lg:flex-row lg:gap-8 lg:py-20 lg:pb-[200px]">
      <figure className="mx-auto max-w-screen-md space-y-[40px]">
        ...
        <blockquote>
          <p className="ml-4 w-full max-w-[535px] align-middle text-3xl leading-[100%] font-black tracking-[0%] sm:text-4xl md:text-5xl lg:ml-[72px] lg:text-[64px]">
        ...
        <svg
          ...
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="mr-4 ml-auto lg:mr-[82px]"
        >
          <path
      ...
      <div className="relative w-full flex-1">
        ...
        <Image
          ...
          height={130}
        />
        <div className="text-primary absolute right-0 bottom-[-60px] z-10 flex w-full max-w-full flex-col items-center justify-between gap-4 bg-[#061665] px-4 py-8 lg:right-[-50px] lg:bottom-[-180px] lg:w-[852px] lg:flex-row lg:gap-0 lg:px-12 lg:py-16">
          <div className="max-w-[430px] text-center align-middle text-xl leading-[100%] font-black tracking-[0%] sm:text-2xl lg:text-left lg:text-[40px]">
